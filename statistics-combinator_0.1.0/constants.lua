...
constants.base_path = "__statistics-combinator__"
constants.blank_image = constants.base_path.."/graphics/blank.png"
constants.gui_image = constants.base_path.."/graphics/gui.png"

constants.entity.name = "production-combinator"
constants.entity.remnants = "production-combinator-remnants"
...
constants.entity.input.name = "production-combinator-input"
...
constants.entity.output.name = "production-combinator-output"
